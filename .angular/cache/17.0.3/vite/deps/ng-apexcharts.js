  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var G = function() {
      ...
      return r(t2, [{ key: "scaleSvgNode", value: function(t3, e2) {
        ...
        d2.push(l2.config.chart.toolbar.export.csv.headerCategory), "boxPlot" === l2.config.chart.type ? (d2.push("minimum"), d2.push("q1"), d2.push("median"), d2.push("q3"), d2.push("maximum")) : "candlestick" === l2.config.chart.type ? (d2.push("open"), d2.push("high"), d2.push("low"), d2.push("close")) : "rangeBar" === l2.config.chart.type ? (d2.push("minimum"), d2.push("maximum")) : i2.map(function(t4, e3) {
        ...
        }), l2.globals.axisCharts || (d2.push(l2.config.chart.toolbar.export.csv.headerValue), g2.push(d2.join(r2))), l2.globals.allSeriesHasEqualX || !l2.globals.axisCharts || "datetime" !== l2.config.xaxis.type || l2.config.xaxis.categories.length || l2.config.labels.length ? i2.map(function(t4, e3) {
          ...
          g2.push([b2(t4) ? l2.config.chart.toolbar.export.csv.dateFormatter(t4) : x.isNumber(t4) ? t4 : t4.split(r2).join(""), c2[t4].join(r2)]);
          ...
          i2.forEach(function(i3) {
            a2[i3] = [], s2[i3] = [], t3.w.config.series.map(function(t4, e3) {
              ...
              for (var o2 = 0; o2 < e2.series[e2.maxValsInArrayIndex].length; o2++) {
                var n2, l2;
                void 0 === a2[i3][o2] && (a2[i3][o2] = 0, s2[i3][o2] = 0), (!t3.w.config.chart.stackOnlyBar || "bar" === (null === (n2 = e2.series) || void 0 === n2 || null === (l2 = n2[r2]) || void 0 === l2 ? void 0 : l2.type) || "bar" === t3.w.config.chart.type) && null !== e2.series[r2][o2] && x.isNumber(e2.series[r2][o2]) && (e2.series[r2][o2] > 0 ? a2[i3][o2] += parseFloat(e2.series[r2][o2]) + 1e-4 : s2[i3][o2] += parseFloat(e2.series[r2][o2]));
              }
            });
    ...
    var ht = function() {
      ...
      return r(t2, [{ key: "createToolbar", value: function() {
        ...
        this.w.globals.allSeriesHasEqualX || this.w.globals.axisCharts && "datetime" === this.w.config.xaxis.type && !this.w.config.xaxis.categories.length && !this.w.config.labels.length || e2.splice(2, 1);
        for (var i2 = 0; i2 < e2.length; i2++)
    ...
    var Mt = function() {
      ...
      return r(t2, [{ key: "sameValueSeriesFix", value: function(t3, e2) {
        ...
        var e2, i2, a2 = t3.i, s2 = t3.series, r2 = t3.prevY, o2 = t3.lineYPosition, n2 = this.w, l2 = n2.config.chart.stacked && (!n2.config.chart.stackOnlyBar || "bar" === (null == s2 || null === (e2 = s2[a2]) || void 0 === e2 ? void 0 : e2.type));
    ...
    var Ft = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
        ...
        }, X2 = h2, E2 = k2.config.chart.stacked && (!this.w.config.chart.stackOnlyBar || "bar" === (null === (e2 = this.w.config.series[o2]) || void 0 === e2 ? void 0 : e2.type)), Y2 = 0; Y2 < r2; Y2++) {
